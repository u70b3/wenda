...
//        Jedis jedis = new Jedis("redis://39.96.191.139:6379/9");
        Jedis jedis = new Jedis("39.96.191.139", 6379);
        jedis.auth("zyq962464");
        jedis.flushDB();
...
//        pool = new JedisPool("redis://60.205.186.158:6379/10");
